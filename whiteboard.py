...
class Whiteboard(tk.Frame):
    def __init__(self, parent, storage_path, width=3000, height=5000):
        ...
        self.brush_size = 3
        self.mode = "pen"  # pen, eraser, select
    ...
    def copy_selected(self):
        if self.mode == "select" and self.selected_tags:
            self.clipboard_data = []
            ...
            messagebox.showinfo("Note", f"Copied {len(self.selected_tags)} strokes")
